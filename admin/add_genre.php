<?php
    ...
    if (isset($_GET['location'])) {
        ...
        $tujuan = "manage_genre.php";
    }

    // Memproses form saat disubmit untuk menambah genre baru
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        $nama_genre = $_POST['nama_genre'];

        // Query untuk menambahkan genre ke dalam tabel genre
        $sql = "INSERT INTO genre (nama_genre) VALUES ('$nama_genre')";
  ...
  <div class="container-fluid d-flex">
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item ">
          <a href="./index.php" class="nav-link text-white d-flex align-items-center gap-3" aria-current="page">
        ...
        <li>
          <a href="./manage_genre.php" class="nav-link active text-white d-flex align-items-center gap-3">
    ...
    <div class="main d-flex flex-grow-1 p-3 flex-column">
      <h2 class="text-center mb-3 align-self-strech"><b>Tambah Genre Novel</b></h2>


      <!-- Form untuk menambah genre baru -->
      <form method="POST" action="" class="mx-auto">
        <div class="form-group mb-2">
          <label for="nama_genre" class="mb-1"><b>Nama Genre:</b> </label>
