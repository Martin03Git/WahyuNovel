...
// Query untuk mengambil semua data author dari tabel 'author'
  ...
  <div class="container-fluid d-flex">
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item ">
          <a href="./index.php" class=" text-reset nav-link d-flex align-items-center gap-3" aria-current="page">
        ...
        <li>
          <a href="manage_author.php" class="nav-link active text-reset text-white d-flex align-items-center gap-3">
    ...
    <div class="main d-flex flex-grow-1 p-3 flex-column">
      <h2 class="text-center  align-self-strech"><b>Manage Author Novel</b></h2>

      <div class="center justify-content-center form-inline mb-2 gap-1">
        <a href="add_author.php" class="btn btn-success">Tambah author</a>
      ...
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><?php echo $row['nama_author']; ?></td>
            <td class="action-links">
              <a href="edit_author.php?id=<?php echo $row['id_author']; ?>" class="btn btn-sm btn-warning">Edit</a>
              <a href="delete_author.php?id=<?php echo $row['id_author']; ?>" class="btn btn-sm btn-danger"
      ...
      <div class="alert alert-info" role="alert">
        Tidak ada data author yang tersedia.
      </div>
      <?php endif; ?>
