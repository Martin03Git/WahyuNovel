...
// Query untuk mengambil semua data genre dari tabel 'genre'
  ...
  <div class="container-fluid d-flex">
    ...
    <div class="sidebar d-flex flex-column flex-shrink-0 p-3 text-bg-dark" style="width: 280px;">
      ...
      <ul class="nav nav-pills flex-column mb-auto">
        ...
        <li>
          <a href="./manage_genre.php" class="nav-link active text-reset text-white d-flex align-items-center gap-3">
    ...
    <div class="main d-flex flex-grow-1 p-3 flex-column">
      <h2 class="text-center  align-self-strech"><b>Manage Genre Novel</b></h2>


      <div class="center align-items-end form-inline mb-2 gap-1">
        <!-- Link untuk menambah genre baru -->
        <a href="add_genre.php" class="btn btn-success">Tambah Genre</a>
        <a href="index.php" class="btn btn-primary">Kembali</a>
      </div>
      

      <!-- Tabel untuk menampilkan daftar genre -->
      <table class="table table-bordered">
        ...
        <tbody>
          ...
          <tr>
            <td class="text-center"><?php echo $row['id_genre']; ?></td>
            <td><?php echo $row['nama_genre']; ?></td>
            <td class="action-links">
              <!-- Link untuk mengedit dan menghapus genre -->
              <a href="edit_genre.php?id=<?php echo $row['id_genre']; ?>" class="btn btn-sm btn-warning">Edit</a>
              <a href="delete_genre.php?id=<?php echo $row['id_genre']; ?>" class="btn btn-sm btn-danger"
