<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Query untuk mengupdate nama genre
        $sql = "UPDATE genre SET nama_genre='$nama_genre' WHERE id_genre=$id";
        if ($conn->query($sql) === TRUE) {
            // Jika berhasil, redirect ke halaman manage_genre.php
...
<body>
  ...
  <div class="container-fluid d-flex">
    ...
    <div class="main d-flex flex-grow-1 p-3 flex-column">
      <h2 class="text-center mb-3 align-self-strech"><b>Manage Genre Novel</b></h2>


      <!-- Form untuk mengedit genre -->
      <form method="POST" action="" class="mx-auto mb-2">
        <div class="form-group mb-2">
          ...
          <input type="text" class="form-control" id="nama_genre" name="nama_genre"
            value="<?php echo $genre['nama_genre']; ?>" required>
        </div>
        <button type="submit" class="btn btn-primary">Simpan</button>
        <button type="reset" class="btn btn-warning">Reset</button>
        <button type="button" class="btn btn-danger" onclick="location.href='manage_genre.php'">Kembali</button>
      </form>
