<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        $sql = "UPDATE author SET nama_author='$nama_author' WHERE id_author=$id";
  ...
  <div class="container-fluid d-flex">
    ...
    <div class="main d-flex flex-grow-1 p-3 flex-column">
      <h2 class="text-center mb-3 align-self-strech"><b>Manage Genre Novel</b></h2>
        ...
        <!-- Form untuk mengedit author -->
        <form method="POST" action="" class="mx-auto">
            <div class="form-group">
                <label for="nama_author" class="mb-1"><b>Nama author:</b> </label>
                <input type="text" class="form-control mb-2" id="nama_author" name="nama_author" value="<?php echo $author['nama_author']; ?>" required>
            </div>
            <button type="submit" class="btn btn-primary">Simpan</button>
            <button type="reset" class="btn btn-warning">Reset</button>
            <button type="button" class="btn btn-danger" onclick="location.href='manage_author.php'">Kembali</button>
        </form>
