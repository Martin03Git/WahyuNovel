<?php
    ...
    // Menangani form submit untuk mengedit user
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        // Mengupdate data user di tabel user
        $sql = "UPDATE user SET nama_user='$nama_user', username='$username', password='$password', level='$level', watchlist='$watchlist' WHERE id_user='$id'";
    ...
    <div class="main d-flex flex-grow-1 p-3 flex-column">
      ...
      <form class="mx-auto" method="POST" action="" enctype="multipart/form-data">
        <div class="form-group mb-2">
          <label for="username"><b>Nama User</b></label>
